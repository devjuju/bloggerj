...
<section class="container py-5 my-1 my-md-4 my-lg-5">
        ...
        <p class="running-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. 
          ...
          <div class="content-post-blog spacing-content-padding-top-40">
          <h2 class="titre-h4">Objectifs</h2>
          <ul class="list-group list-group-flush mb-0">
								<li class="list-group-item h6 fw-light d-flex mb-0">
                  <i class="bi bi-patch-check-fill text-primary me-2"></i>Lorem ipsum dolor sit amet, consectetur adipiscing elit, </li>

								<li class="list-group-item h6 fw-light d-flex mb-0"><i class="bi bi-patch-check-fill text-primary me-2"></i>Lorem ipsum dolor sit amet, consectetur adipiscing elit, </li>
								<li class="list-group-item h6 fw-light d-flex mb-0"><i class="bi bi-patch-check-fill text-primary me-2"></i>Lorem ipsum dolor sit amet, consectetur adipiscing elit,</li>
								<li class="list-group-item h6 fw-light d-flex mb-0"><i class="bi bi-patch-check-fill text-primary me-2"></i>Lorem ipsum dolor sit amet, consectetur adipiscing elit,  </li>
							</ul>
          ...
          <div class="d-flex align-items-center flex-wrap text-muted mb-md-0 mb-4">
            ...
            <h5 class="titre-h6">Outils utilisés :</h5>
            </div>
            <div class="d-flex flex-row bd-highlight mb-3">
                  <div class="bd-highlight me-3">
                     
                    <span class="fs-sm text-category">web</span>
                    <i class="bi bi-arrow-right-circle-fill fs-base me-1 text-primary"></i>
                  </div>
                  <div class="bd-highlight">
              
                    <span class="fs-sm text-primary">React / Javascript </span>
                  </div>
                </div>
...
<div class="card card-background">
                <div class="card-body">
                    ...
                    <a href="index.php?action=login" class="d-grid gap-2 btn btn-outline-primary mb-3">
                          Se connecter
                    </a>

                    <a href="index.php?action=register" class="d-grid gap-2 btn btn-primary">
                           S'inscrire
                    </a>
